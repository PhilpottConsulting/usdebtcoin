    ...
    <div className="bg-gray-800 text-gray-300 py-12 px-6">
      ...
      <div className="max-w-4xl mx-auto space-y-6 text-sm leading-relaxed">
        <p>
          ...
          It is designed to symbolize the U.S. national debt in a satirical, 
          educational, and speculative way.
        </p>
        ...
        <p>
          ...
          We do not guarantee which metric is “correct” — the debate is part of 
          the project itself.
        </p>
        ...
        <p>
          ...
          mass-claiming is possible, but not free.
        </p>
        ...
        <p>
          ...
          and accept no liability. Do your own research, and participate only if 
